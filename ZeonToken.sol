...
{   
    string public constant name = "Zeon Token";
    string public constant symbol = "ZNC";
    uint public constant decimals = 18;
    
    function ZEONToken() public
    {
        totalSupply_ = 50000000000 * 10 ** decimals;
        uint ownersPart = totalSupply_.mul(40).div(100);
        
        balances[msg.sender] = totalSupply_ - ownersPart;
        emit Transfer(0x0, msg.sender, totalSupply_ - ownersPart);
        
        address owners = 0x6B67603f80bc274399d8926Eb2D626B6092DD151;
...
{   
    ...
    uint256 public constant preIcoStart = 1524787200; // Fri, 27 Apr 2018 00:00:00 GMT
    uint256 public constant preIcoEnd = 1527465600; // Mon, 28 May 2018 00:00:00 GMT;
    
    uint256 public constant icoStart = 1528416000; // Fri, 08 Jun 2018 00:00:00 GMT
    uint256 public constant icoEnd = 1531094400; // Mon, 09 Jul 2018 00:00:00 GMT
    
    enum States { NotStarted, PreICO, ICO, Finished }
    States public state;
    
    ZEONToken public token;
    address public constant wallet = 0x6B67603f80bc274399d8926Eb2D626B6092DD151;
    uint256 public constant rate = 769230; // ZNC per 1 ETH

    uint256 public constant preIcoSaleLimit = 5000000000 * 10 ** 18; // ZNC
    
    uint256 public constant minPreIcoPurchase = 5 ether;
    uint256 public constant maxPreIcoPurchase = 6500 ether;
    
    uint256 public constant minIcoPurchase = 120 finney; // 0.12 ETH
    uint256 public constant maxIcoPurchase = 32500 ether;

    uint256 public constant softCap = 5000 ether;
    uint256 public constant hardCap = 39000 ether;
    ...
    function getBonus(uint time, uint256 tokens, uint256 weiAmount) public constant returns (uint256) 
    {
        ...
        {
            if(time >= preIcoStart && time <= preIcoEnd)
            {
    ...
    function () public payable 
    {
        ...
        if(state == States.PreICO && msg.value < minIcoPurchase)
        {
            revert("too small a sum for preIco");
        }
        
        if(state == States.PreICO && msg.value > maxIcoPurchase)
        {
            revert("too big a sum for preIco");
        }
