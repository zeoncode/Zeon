...
namespace Checkpoints
{
    ...
    // Zeon: synchronized checkpoint (centrally broadcasted)
    ...
    // Zeon: get last synchronized checkpoint
    ...
    // Zeon: only descendant of current sync-checkpoint is allowed
    ...
    // Zeon: reset synchronized checkpoint to last hardened checkpoint
...
// Zeon: sync-checkpoint master key
...
// Zeon: verify signature of sync-checkpoint message
...
// Zeon: process synchronized checkpoint
