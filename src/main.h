...
public:
    ...
    {
        // Zeon: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of Zeon spent by this transaction.
    ...
    /** Amount of Zeon coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Zeon: get transaction coin age
...
public:
    ...
    // Zeon: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Zeon: two types of block: proof-of-work or proof-of-stake
    ...
    // Zeon: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Zeon: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Zeon: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Zeon: block index flags
    enum
    {
