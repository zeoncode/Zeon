...
SOURCES += qt/Zeon.cpp qt/Zeongui.cpp \
...
# also add new translations to qt/Zeon.qrc under translations/
TRANSLATIONS = $$files(qt/locale/Zeon_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Zeon-qt.rc

windows:DEFINES += WIN32
windows:RC_FILE = qt/res/Zeon-qt.rc
...
macx:ICON = qt/res/icons/Zeon.icns
macx:TARGET = "Zeon-Qt"
